    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(blank=True, default='users/user_default_profile.png', null=True, upload_to='media/users/pictures/')),
                ('banner', models.ImageField(blank=True, default='users/user_default_bg.jpg', null=True, upload_to='media/users/banners/')),
